...
%%% TCOLORBOX STYLES
\tcbuselibrary{skins,breakable,listingsutf8, fitting}
% Definición del entorno personalizado
\newtcolorbox{ProjectStructure}{
    colback=gray!5,        % Color de fondo
    colframe=gray!80,      % Color del borde
    sharp corners,         % Esquinas rectas
    boxrule=0.5pt,         % Grosor del borde
    left=5pt,              % Espaciado interno izquierdo
    right=5pt,             % Espaciado interno derecho
    top=5pt,               % Espaciado interno superior
    bottom=5pt,            % Espaciado interno inferior
    ...
    enhanced,              % Permite el uso de varwidth dentro
    box align=base,        % Alinear la caja según el contenido
    width=1\textwidth,   % Ajusta el ancho máximo al 80% del ancho del texto
}

% Definición de un entorno para la lista dentro de la caja
